            ...
            <div>
              <div className='social-account-container mt-8'>
                ...
                <div className='social-accounts flex justify-center items-center gap-4 mt-2'>
                  <button className='social-button bg-gradient-to-br from-black to-gray-50 border-white border-5 p-2 rounded-full w-16 h-16 grid place-items-center shadow-md transition duration-200 ease-in-out transform hover:scale-120 active:scale-90'>
                  ...
                  <button className='social-button bg-gradient-to-br from-black to-gray-100 border-white border-5 p-2 rounded-full w-16 h-16 grid place-items-center shadow-md transition duration-200 ease-in-out transform hover:scale-120 active:scale-90'>

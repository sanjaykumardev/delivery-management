    ...
    <>
      ...
      <div className="flex mt-20 md:px-[300px] items-center">
        <div className="md:grid-cols-2 justity-center items-center">
          ...
          <img src="https://img.freepik.com/premium-photo/generic-smartwatches-isolated-colorfull-background-3d-illustration_960782-6343.jpg?w=996" alt="Product" className="w-40% h-[80vh] mr-8" />
          <div className='mt-10'>

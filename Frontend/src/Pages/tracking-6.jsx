        ...
        <div className="mb-8 md:w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-4">
            <div className="md:w-full">
              <img src="https://img.freepik.com/free-photo/smartphones-balancing-with-blue-background_23-2150271748.jpg?w=740&t=st=1709371492~exp=1709372092~hmac=7deff364a5860fd274f3a33bf8efcfbfaf38be4ffb655aa15e3db2a28e36ba7c" alt="Delivery Truck" className="w-100px " />
            </div>

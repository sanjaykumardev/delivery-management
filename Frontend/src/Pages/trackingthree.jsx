        ...
        <div className="mb-8 md:w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-4">
            <div className="md:w-full">
              <img src="https://img.freepik.com/premium-photo/generic-smartwatches-isolated-colorfull-background-3d-illustration_960782-6343.jpg?w=996" alt="Delivery Truck" className="w-100px " />
            </div>

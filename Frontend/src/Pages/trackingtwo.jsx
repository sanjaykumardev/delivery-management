        ...
        <div className="mb-8 md:w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-4">
            <div className="md:w-full">
              <img src="https://imgs.search.brave.com/n5_tJpZim3I9g8-9JYO04UjdJEi9xf5jQELCMpqHPi4/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by9k/aWdpdGFsLWRldmlj/ZS1lbGV0cm9uaWMt/bmV0d29ya2luZy1t/ZWRpYV81Mzg3Ni0z/MTY5NS5qcGc_c2l6/ZT02MjYmZXh0PWpw/Zw" alt="Delivery Truck" className="w-100px " />
            </div>
            <div className="md:w-full text-start ml-20 mb-79">
              <p className="text-4xl font-semibold">Estimated Delivery Date: March 3, 2024</p>
              <p className="text-2xl mt-6 mb-4">Product: Laptop</p>

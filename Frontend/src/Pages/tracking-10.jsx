        ...
        <div className="mb-8 md:w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-4">
            <div className="md:w-full">
              <img src="https://img.freepik.com/free-photo/electronic-device-balancing-concept_23-2150422322.jpg?w=996&t=st=1709372415~exp=1709373015~hmac=c8c6f2a14fbe4126f7e30729b0b0748f988402f5065551db184f097e20e3e5a7" alt="Delivery Truck" className="w-100px " />
            </div>
            <div className="md:w-full text-start ml-20 mb-79">
              <p className="text-4xl font-semibold">Estimated Delivery Date: March 3, 2024</p>
              <p className="text-2xl mt-6 mb-4">Product: ASUS VivoBook</p>

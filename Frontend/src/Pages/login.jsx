...
function Login() {
  ...
  return (
    <div>
      <Navbar />
      <div className='w-full flex justify-center bg-#212121  items-center  h-[80vh]'>
        <div className='flex flex-col justify-center items-center space-y-2 w-[80%] md:w-[25%]'>
          <div className='container max-w-350px bg-gradient-to-b from-white to-gray-100 rounded-3xl p-8 border-5 border-white shadow-lg m-8'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                className='login-button block w-full font-bold bg-gradient-to-br from-blue-500 to-blue-400 text-white px-8 py-6 rounded-full mt-8 mx-auto shadow-md border-none transition duration-200 ease-in-out hover:scale-103 transform'
                type='submit'
              >
                Sign In
              </button>
            ...
            <div className='social-account-container mt-8'>
              ...
              <div className='social-accounts flex justify-center items-center gap-4 mt-2'>
                <button className='social-button bg-gradient-to-br from-black to-gray-400 border-white border-5 p-2 rounded-full w-16 h-16 grid place-items-center shadow-md transition duration-200 ease-in-out transform hover:scale-120 active:scale-90'>

...
function Login() {
  ...
  return (
    <div>
      <Navbar />
      <div className='w-full flex justify-center bg-gray-100  items-center  h-[80vh]'>
        <div className='flex flex-col justify-center items-center space-y-2 mb-20 w-[80%] md:w-[24%]'>
          <div className='container max-w-350px bg-gradient-to-b from-white to-gray-100 rounded-2xl shadow-lg p-8 border-5 border-white  m-8'>

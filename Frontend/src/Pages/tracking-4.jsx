        ...
        <div className="mb-8 md:w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-4">
            <div className="md:w-full">
              <img src="https://img.freepik.com/premium-photo/futuristic-cyborg-driving-simulation-illuminated-virtual-reality-generated-by-ai_188544-13568.jpg?w=996" alt="Delivery Truck" className="w-100px " />
            </div>
            <div className="md:w-full text-start ml-20 mb-79">
              <p className="text-4xl font-semibold">Estimated Delivery Date: March 3, 2024</p>
              <p className="text-2xl mt-6 mb-4">Product: Accurist</p>
